...
const token = '494436136:AAHN-RaV2YBA6jIrHRZheauI0HgaSB7vv60';                 //config.token;
...
bot.onText(/\/start/, (msg) => {
    bot.sendMessage(msg.chat.id, 'This bot allows you to bookmark messages.\n'
        + 'To add teachers surname use command:\n'
        + '`/add key`\n'
...
//ALTER TABLE name ADD COLUMN twitter_handle TEXT; 
