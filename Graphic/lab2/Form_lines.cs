...
namespace Forms_lines
{
    public partial class Form_lines : Form
    {
        public Form_lines()
        {
            InitializeComponent();
        }
        private void Formslines_Paint(object sender, PaintEventArgs e)
        {
            ...
            e.Graphics.DrawLine(redPen , 10,10,50,10);
